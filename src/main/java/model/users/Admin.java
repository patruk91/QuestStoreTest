...
public class Admin extends User {
    ...
    public Admin(int id, String login, String password, String firstName, String lastName, int phoneNum, String adress, String userType, List<Mentor> mentorList, List<Codecooler> codecoolerList, List<Integer> listOfLevels) {
