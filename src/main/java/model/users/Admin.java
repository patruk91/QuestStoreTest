...
public class Admin extends User {
    ...
    private List<Student> codecoolerList;
    private List<Integer> listOfLevels;

    public Admin(int id, String login, String password, String firstName, String lastName, String phoneNum, String email, String address, String userType, List<Mentor> mentorList, List<Student> codecoolerList, List<Integer> listOfLevels) {
    ...
    public Admin(int id, List<Mentor> mentorList, List<Student> codecoolerList, List<Integer> listOfLevels) {
        setId(id);
        this.mentorList = mentorList;
        this.codecoolerList = codecoolerList;
        this.listOfLevels = listOfLevels;
    ...
    public List<Student> getCodecoolerList() {
